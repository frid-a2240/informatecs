    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
              ...
              <li key={item.id} style={{ marginBottom: '0.5rem' }}>
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    backgroundColor: activeSection === item.id ? '#0055aa' : 'transparent',
      ...
      <main style={{ flex: 1, padding: '2rem', backgroundColor: '#f5f5f5' }}>
        {activeSection === 'dashboard' && (
          <div>
            <h2 style={{ fontSize: '1.8rem', marginBottom: '1rem' }}>Panel de Control</h2>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '0.5rem' }}>24</div>
                <div style={{ color: '#666', fontWeight: '500' }}>Eventos Activos</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>👥</div>
                <div style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '0.5rem' }}>1,247</div>
                <div style={{ color: '#666', fontWeight: '500' }}>Usuarios Registrados</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', marginBottom: '0.5rem' }}>✅</div>
                <div style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '0.5rem' }}>356</div>
                <div style={{ color: '#666', fontWeight: '500' }}>Inscripciones Hoy</div>
              </div>
            </div>
          </div>
        )}
