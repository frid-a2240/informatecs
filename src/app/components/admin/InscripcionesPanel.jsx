  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-2">Inscripciones por Actividad</h2>
        <p className="text-gray-600">Lista de estudiantes inscritos en cada actividad</p>
      </div>
                        ...
                        <table className="w-full">
                          ...
                          <tbody className="bg-white divide-y divide-gray-200">
                            {inscritos.map((inscripcion, idx) => {
                              const nombreCompleto = `${inscripcion.estudiante.alunom || ''} ${inscripcion.estudiante.aluapp || ''} ${inscripcion.estudiante.aluapm || ''}`.trim();
